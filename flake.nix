{
  description = "Shannon's Nix Configuration and other miscellaneous sundries";
  ...
  inputs = {
    ...
    let
      ...
      primaryUserInfo = {
        ...
        fullName = "Shannon D. Rush";
        email = "shannon.rush@mavenwave.com";
        nixConfigDirectory = "/Users/shannon.rush/.config/nixpkgs";
      };
    ...
    in
    {
      ...
      darwinConfigurations = rec {
        ...
        # My Intel Silicon macOS laptop config
        hyperion = darwinSystem {
          system = "x86_64-darwin";
          modules = nixDarwinCommonModules ++ [
            {
              users.primaryUser = primaryUserInfo;
              networking.computerName = "Shannon's MBP";
      ...
      homeConfigurations."shannon.rush" = home-manager.lib.homeManagerConfiguration {
      ...
      # This is handy in combination with `nix registry add my /Users/shannon.rush/.config/nixpkgs`
